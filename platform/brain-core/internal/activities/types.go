...
// IndexArtifactRequest is the input for the Go indexer activity.
type IndexArtifactRequest struct {
	...
	EndpointConfig    map[string]any `json:"endpointConfig,omitempty"`
	Checkpoint        map[string]any `json:"checkpoint,omitempty"` // {runId, cursor}
	CdmModelID        string         `json:"cdmModelId,omitempty"`
...
type IndexArtifactResult struct {
	RecordsIndexed int64          `json:"recordsIndexed"`
