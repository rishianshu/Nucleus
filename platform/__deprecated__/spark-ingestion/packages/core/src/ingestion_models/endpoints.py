"""Shared endpoint descriptors, capabilities, and lightweight contracts.

These models are intentionally free of runtime dependencies so they can be
consumed by metadata-service and ingestion-service alike.
"""
...
class EndpointUnitDescriptor:
    ...
    ingestion_strategy: Optional[str] = None  # e.g., full, scd1, cdc
    incremental_column: Optional[str] = None
    incremental_literal: Optional[str] = None  # timestamp | epoch | numeric
