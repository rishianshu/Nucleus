...
except Exception:  # pragma: no cover - allow import without pyspark in test envs
    DataFrame = Any  # type: ignore
    SparkSession = Any  # type: ignore
    F = None  # type: ignore
    col = lit = to_timestamp = None  # type: ignore
    class AnalysisException(Exception):  # type: ignore
        ...
