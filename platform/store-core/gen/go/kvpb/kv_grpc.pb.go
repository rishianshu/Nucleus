...
const (
	KVService_Get_FullMethodName    = "/store.kv.v1.KVService/Get"
	KVService_Put_FullMethodName    = "/store.kv.v1.KVService/Put"
	KVService_Delete_FullMethodName = "/store.kv.v1.KVService/Delete"
	KVService_List_FullMethodName   = "/store.kv.v1.KVService/List"
)
...
var KVService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "store.kv.v1.KVService",
