...
const (
	KVService_Put_FullMethodName      = "/ucl.kv.v1.KVService/Put"
	KVService_Get_FullMethodName      = "/ucl.kv.v1.KVService/Get"
	KVService_Delete_FullMethodName   = "/ucl.kv.v1.KVService/Delete"
	KVService_ListKeys_FullMethodName = "/ucl.kv.v1.KVService/ListKeys"
)
...
//
// KVService provides a multi-tenant key/value store.
...
var KVService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ucl.kv.v1.KVService",
