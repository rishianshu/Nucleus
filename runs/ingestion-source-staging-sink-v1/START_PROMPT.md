...
Feature slug: ingestion-source-staging-sink-v1

Follow AGENT_CODEX.md exactly:

1. Boot:
   - Use this slug.
   - Verify intents/ingestion-source-staging-sink-v1/* exists.
   - Ensure runs/ingestion-source-staging-sink-v1/* exists or create missing run files.
   - Append start/resume heartbeat to LOG.md.
   - Set sync/STATE.md Focus Feature status accordingly.

2. Then follow runs/ingestion-source-staging-sink-v1/RUNCARD.md for:
   - RESUME protocol
   - Loop
   - Guardrails
   - Tasks
