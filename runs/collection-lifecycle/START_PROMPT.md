...
Feature slug: collection-lifecycle

Follow AGENT_CODEX.md exactly:

1. Boot:
   - Use this slug.
   - Verify intents/collection-lifecycle/* exists.
   - Ensure runs/collection-lifecycle/* exists or create missing run files.
   - Append start/resume heartbeat to LOG.md.
   - Set sync/STATE.md Focus Feature status accordingly.

2. Then follow runs/collection-lifecycle/RUNCARD.md for:
   - RESUME protocol
   - Loop
   - Guardrails
   - Tasks
