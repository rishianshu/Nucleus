...
Feature slug: brain-clusters-and-episodes-v1

Follow AGENT_CODEX.md exactly:

1. Boot:
   - Use this slug.
   - Verify intents/brain-clusters-and-episodes-v1/* exists.
   - Ensure runs/brain-clusters-and-episodes-v1/* exists or create missing run files.
   - Append start/resume heartbeat to LOG.md.
   - Set sync/STATE.md Focus Feature status accordingly.

2. Then follow runs/brain-clusters-and-episodes-v1/RUNCARD.md for:
   - RESUME protocol
   - Loop
   - Guardrails
   - Tasks
