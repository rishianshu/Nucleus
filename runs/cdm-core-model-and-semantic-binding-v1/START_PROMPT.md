...
Feature slug: cdm-core-model-and-semantic-binding-v1

Follow AGENT_CODEX.md exactly:

1. Boot:
   - Use this slug.
   - Verify intents/cdm-core-model-and-semantic-binding-v1/* exists.
   - Ensure runs/cdm-core-model-and-semantic-binding-v1/* exists or create missing run files.
   - Append start/resume heartbeat to LOG.md.
   - Set sync/STATE.md Focus Feature status accordingly.

2. Then follow runs/cdm-core-model-and-semantic-binding-v1/RUNCARD.md for:
   - RESUME protocol
   - Loop
   - Guardrails
   - Tasks
