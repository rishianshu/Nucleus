...
Feature slug: metadata-planner-endpoint-hooks-v1

Follow AGENT_CODEX.md exactly:

1. Boot:
   - Use this slug.
   - Verify intents/metadata-planner-endpoint-hooks-v1/* exists.
   - Ensure runs/metadata-planner-endpoint-hooks-v1/* exists or create missing run files.
   - Append start/resume heartbeat to LOG.md.
   - Set sync/STATE.md Focus Feature status accordingly.

2. Then follow runs/metadata-planner-endpoint-hooks-v1/RUNCARD.md for:
   - RESUME protocol
   - Loop
   - Guardrails
   - Tasks
