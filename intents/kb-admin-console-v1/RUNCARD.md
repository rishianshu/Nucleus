## `runs/kb-admin-console-v1/RUNCARD.md`
...
- Follow ADR-UI + ADR-Data-Loading (loading/error/empty; debounced search; cursor pagination). :contentReference[oaicite:13]{index=13} :contentReference[oaicite:14]{index=14}
