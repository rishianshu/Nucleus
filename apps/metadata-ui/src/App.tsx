...
function MetadataWorkspaceShell({ metadataEndpoint, authToken, projectSlug, userRole }: MetadataWorkspaceShellProps) {
  ...
  return (
    ...
    >
      <aside
        className={`flex h-full flex-none flex-col border-r border-slate-200/70 bg-white/80 px-4 py-6 transition-[width] dark:border-slate-800/80 dark:bg-slate-900/70 ${
      ...
      >
        <div className="flex flex-col gap-6">
          ...
          >
            <div className={`flex items-center gap-3 ${shellCollapsed ? "justify-center" : ""}`}>
            ...
            <div
              className={`flex flex-col items-center gap-2 ${shellCollapsed ? "w-full" : ""}`}
            ...
            >
              ...
              <button
                ...
                title={shellCollapsed ? "Expand workspace sidebar" : "Collapse workspace sidebar"}
              >
                {shellCollapsed ? "›" : "‹"}
              </button>
            </div>
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
        {isKnowledgeBaseRoute ? (
          ...
          <SignalsConsole metadataEndpoint={metadataEndpoint} authToken={authToken} />
        ) : isIngestionRoute ? (
          <IngestionConsole
            metadataEndpoint={metadataEndpoint}
            authToken={authToken}
