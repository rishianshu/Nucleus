...
function DocDetailCard({ entity, datasetLookup }) {
    ...
    const sourceUrl = entity.docUrl ?? (typeof entity.data?.url === "string" ? entity.data.url : null) ?? null;
