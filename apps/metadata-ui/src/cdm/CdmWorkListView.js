...
import { CDM_WORK_COMMENTS_QUERY, CDM_WORK_DATASETS_QUERY, CDM_WORK_ITEM_DETAIL_QUERY, CDM_WORK_ITEMS_QUERY, CDM_WORK_LOGS_QUERY, CDM_WORK_PROJECTS_QUERY, CDM_WORK_PROJECT_CONNECTION_QUERY, CDM_WORK_USERS_QUERY, } from "../metadata/queries";
...
function WorkDetailPanel({ row, detail, detailLoading, datasetLookup, projects, }) {
    if (!row) {
