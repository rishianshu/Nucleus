...
export function NodesExplorer({ metadataEndpoint, authToken }) {
    ...
    const { getNodeLabel, matchNodeSynonym, error: metaError, isFallback: metaFallback, refresh: refreshMeta, } = useKbMetaRegistry(metadataEndpoint, authToken ?? undefined, normalizedScope);
