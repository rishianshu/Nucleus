...
export const DEFAULT_ENDPOINT_TEMPLATES: EndpointTemplate[] = [
      ...
      datasets: [
        ...
        },
        {
          ...
          ingestion: {
            ...
            sinkConfig: { datasetSlug: "raw.doc.body" },
          },
        },
        {
        ...
        },
        {
          ...
          ingestion: {
            ...
            displayName: "ACL",
            description: "ACL edges linking principals to docs.",
            supportsIncremental: true,
            defaultPolicy: { acl_principals: ["confluence:public"] },
  ...
  },
  {
    ...
    extras: {
      ingestionUnits: [
        ...
        {
          unitId: "onedrive.acl",
          datasetId: "onedrive.acl",
          kind: "dataset",
          displayName: "OneDrive ACL",
          supportsIncremental: true,
          defaultPolicy: { acl_principals: ["onedrive:public"] },
          cdmModelId: "cdm.doc.access",
        },
      ],
      datasets: [
        ...
        },
        {
          datasetId: "onedrive.acl",
          name: "OneDrive ACL",
          description: "Access control mappings from OneDrive principals to docs/folders.",
          fields: [
            { name: "principalId", dataType: "STRING", nullable: false },
            { name: "principalType", dataType: "STRING", nullable: false },
            { name: "docCdmId", dataType: "STRING", nullable: false },
          ...
          ingestion: {
            unitId: "onedrive.acl",
            displayName: "ACL",
            description: "ACL edges linking principals to docs for delegated/app auth.",
            supportsIncremental: true,
            defaultPolicy: { acl_principals: ["onedrive:public"] },
            cdmModelId: "cdm.doc.access",
          },
  ...
  },
  {
    ...
    title: "GitHub",
    vendor: "GitHub",
    description: "Connect to GitHub REST APIs for code metadata, preview, and ingestion.",
    domain: "code.github",
    categories: ["code", "semantic"],
    protocols: ["https"],
    versions: [],
    descriptorVersion: "1.0.0",
    ...
    agentPrompt: "Provide a GitHub token with repo read scope and optional owner/repo filters. For CI, point base_url to the stub server.",
    defaultLabels: ["github", "code"],
    fields: [
      {
        key: "base_url",
        label: "Base URL",
        required: false,
        valueType: "URL",
        defaultValue: process.env.GITHUB_API_BASE_URL ?? "https://api.github.com",
        placeholder: "https://api.github.com",
        helpText: "Override for stub testing (e.g., http://localhost:8787).",
      },
      {
        key: "token",
        label: "Token",
        ...
        valueType: "PASSWORD",
        sensitive: true,
        description: "GitHub PAT/app token (optional for public repos; recommended to avoid rate limits).",
      },
      {
        key: "owners",
        ...
        helpText: "Comma-separated owners/orgs to include.",
      },
      {
        key: "repos",
        ...
        required: false,
        valueType: "TEXT",
        placeholder: "octo-org/alpha,octo-org/beta",
        helpText: "Comma-separated repos to include; defaults to all repos for the token.",
      },
      {
        key: "branch",
        label: "Branch/ref",
        ...
        valueType: "TEXT",
        placeholder: "main",
        helpText: "Override branch/ref for preview/ingestion; defaults to repo default branch.",
      },
      {
        key: "path_prefixes",
        label: "Path prefixes",
        ...
        helpText: "Comma-separated path prefixes for slicing/ingestion.",
      },
      {
        key: "file_extensions_include",
        label: "File extensions include",
        required: false,
        valueType: "TEXT",
        placeholder: ".go,.ts,.md",
        helpText: "Restrict ingestion to specific extensions (comma-separated).",
      },
      {
        key: "max_file_bytes",
        ...
        helpText: "Reject files larger than this limit for preview/ingestion.",
      },
      {
        key: "chunk_bytes",
        label: "Chunk bytes",
        ...
        valueType: "INTEGER",
        defaultValue: "8000",
        helpText: "Chunk size for raw.code.file_chunk outputs.",
      },
      {
        key: "overlap_bytes",
        label: "Overlap bytes",
        ...
        valueType: "INTEGER",
        defaultValue: "400",
        helpText: "Chunk overlap for sliding window chunking.",
      },
      {
        key: "tenant_id",
        label: "Tenant ID",
        required: false,
        valueType: "TEXT",
        placeholder: "tenant-github",
        helpText: "Used in catalog dataset keys (catalog.dataset:code.repo:{tenantId}:{projectKey}).",
      },
    ],
    capabilities: [
      {
        key: "metadata",
        label: "Metadata collection",
        description: "Lists repositories as catalog datasets with canonical keys.",
      },
      {
        key: "preview",
        label: "Preview",
        description: "Previews repository files with binary/size safety checks.",
      },
      {
        key: "ingestion",
        label: "Ingestion",
        description: "Plans slices and stages raw.code.file + raw.code.file_chunk records.",
      },
    ],
    auth: {
      modes: [
        { mode: "service_pat", label: "Service PAT", requiredFields: ["token"], scopes: ["repo"], interactive: false },
        { mode: "delegated_auth_code_pkce", label: "Delegated (OAuth PKCE)", scopes: ["repo", "read:user"], interactive: true },
      ],
      profileBinding: { supported: true, principalKinds: ["user"] },
    },
    sampleConfig: {
      templateId: "http.github",
      parameters: {
        base_url: process.env.GITHUB_STUB_URL ?? "http://localhost:8787",
        token: "stub-token",
        owners: "octo",
      ...
      ingestionUnits: [
        {
          ...
          supportsIncremental: false,
          defaultPolicy: { target_slice_size: 100 },
          cdmModelId: null,
        },
        {
          unitId: "github.issues",
          datasetId: "github.issues",
          kind: "dataset",
          displayName: "Issues",
          description: "GitHub issues (state, title, body, labels, timestamps).",
          supportsIncremental: true,
          defaultPolicy: { target_slice_size: 100 },
          cdmModelId: null,
        },
        {
          unitId: "github.pull_requests",
          datasetId: "github.pull_requests",
          kind: "dataset",
          displayName: "Pull Requests",
          description: "GitHub pull requests (title, branches, state, merge flags).",
          supportsIncremental: true,
          defaultPolicy: { target_slice_size: 100 },
          cdmModelId: null,
        },
        {
          unitId: "github.commits",
          datasetId: "github.commits",
          kind: "dataset",
          displayName: "Commits",
          description: "Commit history with authorship and timestamps.",
          supportsIncremental: true,
          defaultPolicy: { target_slice_size: 100 },
          cdmModelId: null,
        },
        {
          unitId: "github.comments",
          datasetId: "github.comments",
          kind: "dataset",
          displayName: "Comments",
          description: "Issue and pull-request comments.",
          supportsIncremental: true,
          defaultPolicy: { target_slice_size: 100 },
          cdmModelId: null,
        },
        {
          unitId: "github.releases",
          datasetId: "github.releases",
          kind: "dataset",
          displayName: "Releases",
          description: "Published releases and tags.",
          supportsIncremental: false,
          defaultPolicy: { target_slice_size: 100 },
          cdmModelId: null,
        },
      ...
      datasets: [
        {
          ...
          description: "Repositories exposed as catalog datasets.",
          fields: [
          ...
          ingestion: {
            ...
            description: "GitHub repositories available to ingest.",
            supportsIncremental: false,
            defaultPolicy: { target_slice_size: 100 },
            datasetSlug: "raw.code.file_chunk",
          },
        },
        {
          datasetId: "github.issues",
          name: "GitHub Issues",
          description: "Issues for configured repositories.",
          fields: [
          ...
          ingestion: {
            unitId: "github.issues",
            displayName: "Issues",
            description: "GitHub issues with incremental sync.",
            supportsIncremental: true,
            defaultPolicy: { target_slice_size: 100 },
            datasetSlug: "raw.github.issues",
          },
        },
        {
          datasetId: "github.pull_requests",
          name: "GitHub Pull Requests",
          description: "Pull requests for configured repositories.",
          fields: [
          ...
          ingestion: {
            unitId: "github.pull_requests",
            displayName: "Pull Requests",
            description: "GitHub pull requests with incremental sync.",
            supportsIncremental: true,
            defaultPolicy: { target_slice_size: 100 },
            datasetSlug: "raw.github.pull_requests",
          },
        },
        {
          datasetId: "github.commits",
          name: "GitHub Commits",
          description: "Commit history for configured repositories.",
          fields: [
          ...
          ingestion: {
            unitId: "github.commits",
            displayName: "Commits",
            description: "Commit history with incremental sync.",
            supportsIncremental: true,
            defaultPolicy: { target_slice_size: 100 },
            datasetSlug: "raw.github.commits",
          },
        },
        {
          datasetId: "github.comments",
          ...
          ingestion: {
            unitId: "github.comments",
            displayName: "Comments",
            description: "Issue/PR comments with incremental sync.",
            supportsIncremental: true,
            defaultPolicy: { target_slice_size: 100 },
            datasetSlug: "raw.github.comments",
          },
        },
        {
          datasetId: "github.releases",
          name: "GitHub Releases",
          description: "Published releases for configured repositories.",
          fields: [
          ...
          ingestion: {
            unitId: "github.releases",
            displayName: "Releases",
            description: "Published releases (full sync).",
            supportsIncremental: false,
            defaultPolicy: { target_slice_size: 100 },
            datasetSlug: "raw.github.releases",
          },
        },
      ],
    },
    ...
    extras: {
      ...
      ingestionUnits: [
        ...
        },
        {
          ...
          sinkConfig: { datasetSlug: "raw.cdm.work" },
        },
        {
          unitId: "jira.users",
        ...
        },
        {
          ...
          sinkConfig: { datasetSlug: "raw.cdm.comment" },
        },
        {
          ...
          sinkConfig: { datasetSlug: "raw.cdm.worklog" },
        },
      ],
    },
  },
